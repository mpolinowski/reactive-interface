...
var AddProduct = React.createClass({
  ...
  handleAdd: function(e) {
    ...
    e.preventDefault();
    this.props.AddProductSubmit(tempItem);
  }, // Prevent default sending / reloading behaviour of submit button and send tempItem to main component
        ...
        <div className='row'>
          <div className='panel panel-primary add-panel'>
            ...
            <div className='panel-body' style={ diplayProductBody }>
              <form className='add-product form-horizontal' onSubmit = { this.handleAdd }>
                <div className='form-group'>
                  <label className='col-sm-2 control-label' for='modelNo'>Model #</label>
                  <div className='col-sm-7'>
                    <input type='text' className='form-control'
                      id='modelNo' ref='inputModelNo' placeholder='E.g. IN-8015HD' />
                  </div>
                  <label className='col-sm-1 control-label' for='stockLeft'>Stock</label>
                  <div className='col-sm-2'>
                    <input type='text' className='form-control'
                      id='stockLeft' placeholder='E.g. 65' />
                  </div>
                </div>
                <div className='form-group'>
                  <label className='col-sm-2 control-label' for='camType'>Type</label>
                ...
                <div className='form-group'>
                  <label className='col-sm-2 control-label' for='modelNotes'>Product Notes</label>
                  <div className='col-sm-10'>
